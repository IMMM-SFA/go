...
def mpreduction(mpc, exbusorig, pf_flag):
    ...
    ----------
        ...
        ExBusOrig (n*1 vector): Includes the bus numbers of buses to be eliminated.
        Pf_flag (scalar): Indicates if dc power flow needed to solve (=1) or not
    ...
    Notes
    -------
        The reduction is based on dc assumption which means all resistance,
    ...
    mpc, exbusorig = pre_process_data(mpc, exbusorig)
