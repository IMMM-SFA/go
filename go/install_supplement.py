...
class InstallSupplement:
    ...
    def fetch_zenodo(self):
        ...
        current go distribution."""

        # full path to the go root directory where the example dir will be stored
        data_directory = pkg.get_data_directory()

        # get the current version of go that is installed
        current_version = get_distribution('go').version
        ...
        print("Downloading example data for go version {}...".format(current_version))
